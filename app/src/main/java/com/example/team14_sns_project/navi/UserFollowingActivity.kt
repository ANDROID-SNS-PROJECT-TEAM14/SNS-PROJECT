...
import com.example.team14_sns_project.databinding.ActivityUserFollowingBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.firestore.FirebaseFirestore

class UserFollowingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val recyclerView = binding.userFollowingRecyclerView
        val layoutManager = LinearLayoutManager(this)

        // adapter
        val adapter = UserFollowingAdapter(this)
        // 현재 사용자의 정보들을 설정해준다.
        ...
        userFollowing.get().addOnSuccessListener { result ->
            ...
            userFollowing.get()
                .addOnSuccessListener { result ->
                    ...
                    for (document in result) {
                        userFollowing.document(document.id).get().addOnSuccessListener {
        ...
        // 검색창
        val searchView = binding.userFollowingSearchView
